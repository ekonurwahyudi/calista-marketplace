            ...
            <div class="cart__items">
                ...
                <div class="shopping-card">
                    <a href="#" class="shopping-card__image">
                        <img src="{{ url('assets/images/cart/cart-01.png') }}" alt="cart-product" />
                    </a>
                ...
                <div class="shopping-card">
                    <a href="#" class="shopping-card__image">
                        <img src="{{ url('assets/images/cart/cart-02.png') }}" alt="cart-product" />
                    </a>
                    <div class="shopping-card__content">
                        <div class="shopping-card__content-top">
                            <h5 class="product__title">
                ...
                <div class="shopping-card">
                    <a href="#" class="shopping-card__image">
                        <img src="{{ url('assets/images/cart/cart-03.png') }}" alt="cart-product" />
                    </a>
                    <div class="shopping-card__content">
                        <div class="shopping-card__content-top">
                            <h5 class="product__title">
                ...
                <div class="shopping-card">
                    <a href="#" class="shopping-card__image">
                        <img src="{{ url('assets/images/cart/cart-04.png') }}" alt="cart-product" />
                    </a>
                    <div class="shopping-card__content">
                        <div class="shopping-card__content-top">
                            <h5 class="product__title">
