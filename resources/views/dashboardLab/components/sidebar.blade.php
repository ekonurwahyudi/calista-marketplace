...
<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar"
    ...
    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
        ...
        <a href="../../demo1/dist/index.html">
            <img alt="Logo" src="{{ url('/dashboards/assets/media/logos/putih.png') }}"
                class=" h-25px app-sidebar-logo-default" />
            <img alt="Logo" src="{{ url('/dashboards/assets/media/logos/sa.png') }}"
    ...
    <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5"
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                ...
                <!--begin:Menu item-->
                <div class="menu-item menu-item here">
                    <!--begin:Menu link-->
                ...
                <div class="menu-item pt-5">
                    ...
                    <div class="menu-content">
                        <span class="menu-heading fw-bold text-uppercase fs-7">Manage Orders</span>
                    </div>
                    <!--end:Menu content-->
                </div>
                <!--end:Menu item-->
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link" href="{{ route('add-product') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                ...
                <div class="menu-item">
                    ...
                    <a class="menu-link" href="/">
                        ...
                        <span class="menu-title">Daftar Orderan</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                ...
                <div class="menu-item pt-5">
                    <!--begin:Menu content-->
                    <div class="menu-content">
                        <span class="menu-heading fw-bold text-uppercase fs-7">Pengaturan Toko</span>
                    </div>
                    <!--end:Menu content-->
                </div>
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link" href="/dashboards/setting-lab/{{ Auth::user()->id }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                ...
                <div class="menu-item pt-5">
                    <!--begin:Menu content-->
                    <div class="menu-content">
                        <span class="menu-heading fw-bold text-uppercase fs-7">Iklan & Promosi</span>
                    </div>
                    <!--end:Menu content-->
                </div>
                ...
                <div class="menu-item">
                    ...
                    <a class="menu-link" href="/">
                        ...
                        <span class="menu-title">Iklankan Produk</span>
                    </a>
                    <!--end:Menu link-->
                </div>
    ...
    <div class="app-sidebar-footer flex-column-auto pt-2 pb-6 px-6" id="kt_app_sidebar_footer">
        <a href="https://preview.keenthemes.com/html/metronic/docs"
            ...
            <span class="btn-label">Customer Support</span>
